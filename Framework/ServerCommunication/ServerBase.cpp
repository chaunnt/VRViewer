...
QByteArray ServerBase::_executeGETrequest(QNetworkRequest newRequest, bool isHaveToWait)
{
...
QByteArray ServerBase::_executePOSTrequest(QNetworkRequest newRequest, QByteArray newBodyData, bool isHaveToWait)
{
    QByteArray responseData;
    if (isHaveToWait)
    {
...
QByteArray ServerBase::_executePUTrequest(QNetworkRequest newRequest, QByteArray newBodyData, bool isHaveToWait)
{
    QByteArray responseData;
    if (isHaveToWait)
    {
